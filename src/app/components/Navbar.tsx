  ...
  const icons = [
    {
      ...
      jsx: (
        <svg
          ...
          viewBox="0 0 24 24"
          className="w-4 h-4"
          style={{ filter: getInvertFilter(0) }}
        >
    ...
    },
    {
      ...
      jsx: (
        <svg
          ...
          viewBox="0 0 24 24"
          className="w-4 h-4"
          style={{ filter: getInvertFilter(1) }}
        >
          <path
            fillRule="evenodd"
    ...
    },
    {
      ...
      jsx: (
        <svg
          ...
          viewBox="0 0 24 24"
          className="w-4 h-4"
          style={{ filter: getInvertFilter(2) }}
        >
    ...
    },
    {
      ...
      jsx: (
        <svg
          ...
          viewBox="0 0 24 24"
          className="w-4 h-4"
          style={{ filter: getInvertFilter(3) }}
        >
          <path
            fillRule="evenodd"
    ...
    },
    {
      ...
      jsx: (
        <svg
          ...
          viewBox="0 0 24 24"
          className="w-4 h-4"
          style={{ filter: getInvertFilter(4) }}
        >
    ...
    },
    {
      ...
      jsx: (
        <svg
          ...
          viewBox="0 0 24 24"
          className="w-4 h-4"
          style={{ filter: getInvertFilter(5) }}
        >
          <path
            fillRule="evenodd"
    ...
    },
    {
      ...
      jsx: (
        <svg
          ...
          viewBox="0 0 24 24"
          className="w-4 h-4"
          style={{ filter: getInvertFilter(6) }}
        >
          <path
            fillRule="evenodd"
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-[52px]">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="w-[52px] h-[34px] flex items-center justify-center cursor-pointer transition-all">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
